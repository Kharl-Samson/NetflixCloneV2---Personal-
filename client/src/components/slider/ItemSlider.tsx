        ...
        <div className="p-4 cursor-pointer hover:cursor-pointer">
          ...
          <div className="flex items-center gap-x-2">
            ...
            <LightTooltip title="Add to My List" arrow sx={{'& .MuiTooltip-arrow': {color: '#ffff',},}}>
              <div className="bg-[#232323] rounded-full h-11 w-11 flex items-center justify-center border-2 border-[#8b8b8b]" id="notValidModal16">
                <img src={add} alt="Play Icon" className="h-5" id="notValidModal17"/>
              </div>
            </LightTooltip>
