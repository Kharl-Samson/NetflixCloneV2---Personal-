  ...
  return (
    ...
    >
      ...
      itemHover === index && screenWidth >= 640 &&
        <div className={`w-full h-[14.063rem] mt-[-14.063rem] overflow-hidden cursor-pointer hover:cursor-pointer items-center justify-center relative z-0 none sm:flex`}>
          <YoutubePlayerItem
